...
subject_integer_df$subject <- as.character(subject_df$subject)

lm(f0mn ~ scenario, data = subject_integer_df)
 212.75        62.40        35.35        53.75        27.30        -7.55       -14.95  
lm(f0mn ~ scenario, data = politeness)
  183.623       24.731       25.964       28.526       13.577        2.984        5.952  
```
