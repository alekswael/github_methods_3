...
# - Scenario: Categorized as 7 different scenarios of dialogue between participants
# - Attitude: Either formal or informal condition
# - Total duration: Duration of scenario
...
# Make model with the two encodings
...
# We see by comparing residual standard deviation and AIC scores of m2 (intercepts for scenario) and m3 (intercepts for subjects) that random intercepts by subjects explain more variance than scenario. Using only random intercepts by subject as a second-level effect has a lower sigma value (32.04) and AIC score (2099.63) than by scenario.
...
# Whats the difference between interactions and random slopes?
```
